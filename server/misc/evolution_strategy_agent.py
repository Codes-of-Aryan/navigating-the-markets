...
def main(df_path="./dataset/TSLA.csv"):
    ...
    agent = Agent(model, 10000, 5, 5, window_size, close, skip, length, show_graph=True, debug=True)
    agent.fit(500, 10)
...
if __name__ == '__main__':
    df_path = "./dataset/TSLA.csv"
    main(df_path=df_path)