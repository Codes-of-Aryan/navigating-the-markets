...
<html>
        ...
        <ul class="collapsible" data-collapsible="accordion">
            <li>
                <div class="collapsible-header">
                    ...
                    >
                        <div class="col s3 m1">Settings</div>
                        <div
                            class="input-field col s12 m1 right"
                        ...
                        <div
                            class="file-field input-field col s12 m1 right"
                            style="margin-top: 5px; width: 160px"
                        >
                            <div
                ...
                <div class="collapsible-body">
                    <span>
                        <div class="row center">
                            <div
                                class="input-field col m2 offset-m1"
                                style="margin-left: 5.33%"
                            >
                            ...
                            <div class="input-field col s12 m1">
                                <input
                                    ...
                                    data-delay="50"
                                    data-tooltip="learning rate during training"
                                />
                            ...
                            <div class="input-field col s12 m1">
                                <input
                                    ...
                                    data-position="bottom"
                                    data-delay="50"
                                    data-tooltip="dropout rate for LSTM input"
                                />
                                <label class="active">Input dropout rate</label>
                            </div>
                            <div class="input-field col s12 m1">
                                <input
                                    id="outputdropoutrate"
                                    type="number"
                                    placeholder="Eg: 0.9"
                                    class="validate tooltipped"
                                    data-position="bottom"
                                    data-delay="50"
                                    data-tooltip="dropout rate for LSTM output"
                                />
                                <label class="active"
                                    >Output dropout rate</label
                                >
                            </div>
                            <div class="input-field col s12 m1">
                                <input
                                    ...
                                    data-position="bottom"
                                    data-delay="50"
                                    data-tooltip="Trends for every minibatch"
                                />
                                <label class="active"
                                    >Timestamp per training</label
                                >
                            </div>
                            <div class="input-field col s12 m1">
                                <input
                            ...
                            <div class="input-field col s12 m1">
                                <input
                                    ...
                                    data-position="bottom"
                                    data-delay="50"
                                    data-tooltip="number of days forecast"
                                />
                                <label class="active"
                                    >Future days to forecast</label
                                >
                            </div>
                            <div class="input-field col s12 m1">
                                <input
                                    ...
                                    data-position="bottom"
                                    data-delay="50"
                                    data-tooltip="Rate anchor smoothing for trends"
                                />
                        ...
                        <div class="row center">
                            ...
                            <div class="input-field col s12 m2">
                                <input
                                    ...
                                    data-position="bottom"
                                    data-delay="50"
                                    data-tooltip="Money in for simulation"
                                />
    ...
    <h6 class="header center light">
        WARNING, This website may hang during training, and do not use this
        website to buy real stock!<br /><br />Default stock is Google 2018, you
        can try upload any stock CSV
    </h6>
