...
import '../../assets/lstm-algo-css/materialize-css/dist/css/materialize.min.css';
// import './style.css';
// import * as tf from 'tf.js';
// import $ from 'jquery';
// import * as d3 from 'd3';
// import * as numeric from 'numeric-1.2.6.min';
// import * as nj from 'numjs.min';
...
function LSTMAlgo() {
    return (
        <div>
            <div class="row" style="padding-left:10px;padding-right:10px; background-color: #f1f2ec;">
            ...
            <div class='header center light'>WARNING, This website may hang during training, and do not use this website to buy real stock!<br /><br />Default stock is Google 2018, you can try upload any stock CSV</div>
